...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_mobile_checksum_func_get_address() != 19409) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mobile_checksum_func_get_private_key() != 36471) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mobile_checksum_func_get_script_hash() != 59532) {
        return InitializationResult.apiChecksumMismatch
    }
